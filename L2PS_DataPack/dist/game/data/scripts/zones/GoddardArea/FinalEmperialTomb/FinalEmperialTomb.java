 ...
 */
package zones.GoddardArea.FinalEmperialTomb;
...
public class FinalEmperialTomb extends Quest
{
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		if (npcId == GUIDE)
		{
			enterInstance(player, "FinalEmperialTomb/FinalEmperialTomb.xml", ENTER_TELEPORT);
		}
	...
	{
		new FinalEmperialTomb(-1, FinalEmperialTomb.class.getSimpleName(), "zones/GoddardArea/");
	}
}