...
public class FreyaMinions extends AbstractNpcAI
{
	...
	{
		ExFreyaMessages sm = new ExFreyaMessages(1801111, 3000, ExFreyaMessages.ScreenMessageAlign.MIDDLE_CENTER, true, false, -1, false);
	...
	{
		new FreyaMinions(-1, FreyaMinions.class.getSimpleName(), "zones/Freya/");
	}
}