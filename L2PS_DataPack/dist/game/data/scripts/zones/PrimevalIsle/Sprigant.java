...
public final class Sprigant extends AbstractNpcAI
{
	...
	private Sprigant()
	{
		super(Sprigant.class.getSimpleName(), "zones/PrimevalIsle/");
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		{
			npc.doCast((npc.getNpcId() == ANESTHESIA_SPRIGNANT ? ANESTHESIA.getSkill() : DEADLY_POISON.getSkill()));
