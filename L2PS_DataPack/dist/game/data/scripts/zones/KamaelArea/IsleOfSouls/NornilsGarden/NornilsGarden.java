 ...
 */
package zones.KamaelArea.IsleOfSouls.NornilsGarden;
...
public class NornilsGarden extends Quest
{
	...
	private final synchronized String enterInstance(L2Npc npc, L2PcInstance player)
	{
		...
		final int instanceId = InstanceManager.getInstance().createDynamicInstance("IsleOfSouls/NornilsGarden.xml");
	...
	{
		new NornilsGarden(-1, qn, "zones/KamaelArea/IsleOfSouls/");
	}
}
