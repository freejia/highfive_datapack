 ...
 */
package zones.GraciaContinents.SeedOfDestruction;
...
public class SeedOfDestruction extends Quest
{
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		if (npcId == ALENOS)
		{
			if (SoDManager.getInstance().getSoDState() == 1)
			{
				...
				tele.y = 219981;
				tele.z = -9986;
				enterInstance(player, "GraciaContinents/SeedOfDestruction.xml", tele);
			}
	...
	{
		new SeedOfDestruction(-1, SeedOfDestruction.class.getSimpleName(), "zones/GraciaContinents/");
	}
}