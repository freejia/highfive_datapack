 ...
 */
package zones.GraciaContinents.SecretArea;
...
public class SecretArea extends Quest
{
	...
	protected void enterInstance(L2PcInstance player)
	{
		...
		{
			final int instanceId = InstanceManager.getInstance().createDynamicInstance("GraciaContinents/SecretArea.xml");
	...
	{
		new SecretArea(-1, SecretArea.class.getSimpleName(), "zones/GraciaContinents/");
	}
}
