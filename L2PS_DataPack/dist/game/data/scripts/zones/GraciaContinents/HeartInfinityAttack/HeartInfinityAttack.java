 ...
 */
package zones.GraciaContinents.HeartInfinityAttack;
...
public class HeartInfinityAttack extends Quest
{
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		if (npcId == ABYSSGAZE)
		{
			enterInstance(player, "GraciaContinents/HeartInfinityAttack.xml", ENTER_TELEPORT);
		}
		return "";
	}
	...
	{
		new HeartInfinityAttack(-1, HeartInfinityAttack.class.getSimpleName(), "zones/GraciaContinents/");
	}
}