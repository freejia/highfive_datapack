 ...
 */
package zones.SevenSigns.LibraryOfSages;
...
public class LibraryOfSages extends Quest
{
	...
	private void teleportPlayer(L2Npc npc, L2PcInstance player, int[] coords, int instanceId)
	{
		...
		if (holder == null /* (instanceId > 0) */) // this block check only for NPE
		{
	...
	protected void enterInstance(L2Npc npc, L2PcInstance player)
	{
		...
		final int instanceId = InstanceManager.getInstance().createDynamicInstance("SevenSigns/LibraryOfSages.xml");
	...
	{
		new LibraryOfSages(-1, LibraryOfSages.class.getSimpleName(), "zones/SevenSigns/");
	}
}
