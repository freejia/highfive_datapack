 ...
 */
package zones.SevenSigns.SanctumOftheLordsOfDawn;
...
public class SanctumOftheLordsOfDawn extends Quest
{
	...
	public String onTalk(L2Npc npc, L2PcInstance talker)
	{
		switch (npc.getNpcId())
		{
			case LIGHT_OF_DAWN:
			{
				...
				{
					enterInstance(talker, "SevenSigns/SanctumoftheLordsofDawn.xml", ENTER);
	...
	{
		new SanctumOftheLordsOfDawn(-1, SanctumOftheLordsOfDawn.class.getSimpleName(), "zones/SevenSigns/");
	}
}
