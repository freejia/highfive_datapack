 ...
 */
package zones.SevenSigns.HideoutOfTheDawn;
...
public class HideoutOfTheDawn extends Quest
{
	...
	public String onTalk(L2Npc npc, L2PcInstance talker)
	{
		switch (npc.getNpcId())
		{
			case WOOD:
			{
				enterInstance(talker, "SevenSigns/HideoutOfTheDawn.xml", WOOD_LOC);
				return "32593-01.htm";
			}
			case JAINA:
			{
	...
	{
		new HideoutOfTheDawn(-1, HideoutOfTheDawn.class.getSimpleName(), "zones/SevenSigns/");
	}
}