...
public class StatManager implements ScriptFile, ICommunityBoardHandler
{
	...
	/**
	 * A command handler class @ param Player - Player (Caller) @ param command - command processing
	 */
	@Override
	public void onBypassCommand(Player player, String command)
	{
		...
		{
			ShowBoard.separateAndSend("<html><body><br><br><center>In community stats function: " + command + " not implemented yet</center><br><br></body></html>", player);
		}
	}
	
	/**
	 * Call display the current list of the top 20 players on PVP indicator      * Carry out in-class konekt and cheking the table (given the parameters)
	 * @param player
	 */
	...
	/**
	 * Call display the current list of the top 20 players on the PK index      * Carry out in-class konekt and cheking the table (given the parameters)
	 * @param player
	 */
	...
	/**
	 * Unused, but the called method implement
	 */
	@Override
