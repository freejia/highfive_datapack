...
import l2f.gameserver.network.serverpackets.ExMailArrived;
...
public class ClanCommunity extends Functions implements ScriptFile, ICommunityBoardHandler
{
	...
	public class Listener implements OnPlayerEnterListener
	{
		@Override
	...
	public static class ClansComparator<T> implements Comparator<T>
	{
		@Override
