 ...
 */
public class PremiumNpcBuffer extends Quest
{
	...
	private static final String PREMIUM_TITLE_NAME = "Premium Buffer by L2PS with enchanted buffs";
	private static final boolean PREMIUM_SCRIPT_RELOAD = true;
	private static final boolean PREMIUM_SMART_WINDOW = Config.PremiumNpcBuffer_SmartWindow;
	private static final boolean PREMIUM_ENABLE_VIP_BUFFER = Config.PremiumNpcBuffer_VIP;
	private static final boolean PREMIUM_ENABLE_BUFF_SECTION = Config.PremiumNpcBuffer_EnableBuff;
	private static final boolean PREMIUM_ENABLE_SCHEME_SYSTEM = Config.PremiumNpcBuffer_EnableScheme;
	private static final boolean PREMIUM_ENABLE_HEAL = Config.PremiumNpcBuffer_EnableHeal;
	private static final boolean PREMIUM_ENABLE_BUFFS = Config.PremiumNpcBuffer_EnableBuffs;
	private static final boolean PREMIUM_ENABLE_RESIST = Config.PremiumNpcBuffer_EnableResist;
	private static final boolean PREMIUM_ENABLE_SONGS = Config.PremiumNpcBuffer_EnableSong;
	private static final boolean PREMIUM_ENABLE_DANCES = Config.PremiumNpcBuffer_EnableDance;
	private static final boolean PREMIUM_ENABLE_CHANTS = Config.PremiumNpcBuffer_EnableChant;
	private static final boolean PREMIUM_ENABLE_OTHERS = Config.PremiumNpcBuffer_EnableOther;
	private static final boolean PREMIUM_ENABLE_SPECIAL = Config.PremiumNpcBuffer_EnableSpecial;
	private static final boolean PREMIUM_ENABLE_CUBIC = Config.PremiumNpcBuffer_EnableCubic;
	private static final boolean PREMIUM_ENABLE_BUFF_REMOVE = Config.PremiumNpcBuffer_EnableCancel;
	private static final boolean PREMIUM_ENABLE_BUFF_SET = Config.PremiumNpcBuffer_EnableBuffSet;
	private static final boolean PREMIUM_BUFF_WITH_KARMA = Config.PremiumNpcBuffer_EnableBuffPK;
	private static final boolean PREMIUM_FREE_BUFFS = Config.PremiumNpcBuffer_EnableFreeBuffs;
	private static final boolean PREMIUM_TIME_OUT = Config.PremiumNpcBuffer_EnableTimeOut;
	private static final int PREMIUM_TIME_OUT_TIME = Config.PremiumNpcBuffer_TimeOutTime;
	private static final int PREMIUM_MIN_LEVEL = Config.PremiumNpcBuffer_MinLevel;
	private static final int PREMIUM_BUFF_REMOVE_PRICE = Config.PremiumNpcBuffer_PriceCancel;
	private static final int PREMIUM_HEAL_PRICE = Config.PremiumNpcBuffer_PriceHeal;
	private static final int PREMIUM_BUFF_PRICE = Config.PremiumNpcBuffer_PriceBuffs;
	private static final int PREMIUM_RESIST_PRICE = Config.PremiumNpcBuffer_PriceResist;
	private static final int PREMIUM_SONG_PRICE = Config.PremiumNpcBuffer_PriceSong;
	private static final int PREMIUM_DANCE_PRICE = Config.PremiumNpcBuffer_PriceDance;
	private static final int PREMIUM_CHANT_PRICE = Config.PremiumNpcBuffer_PriceChant;
	private static final int PREMIUM_OTHERS_PRICE = Config.PremiumNpcBuffer_PriceOther;
	private static final int PREMIUM_SPECIAL_PRICE = Config.PremiumNpcBuffer_PriceSpecial;
	private static final int PREMIUM_CUBIC_PRICE = Config.PremiumNpcBuffer_PriceCubic;
	private static final int PREMIUM_BUFF_SET_PRICE = Config.PremiumNpcBuffer_PriceSet;
	private static final int PREMIUM_SCHEME_BUFF_PRICE = Config.PremiumNpcBuffer_PriceScheme;
	private static final int PREMIUM_SCHEMES_PER_PLAYER = Config.PremiumNpcBuffer_MaxScheme;
	private static final int PREMIUM_CONSUMABLE_ID = Config.PremiumNpcBuffer_consumableID;
	private static final int PREMIUM_MAX_SCHEME_BUFFS = Config.PremiumBuffMaxAmount;
	private static final int PREMIUM_MAX_SCHEME_DANCES = Config.PremiumDanceMaxAmout;
	
	private static final String PREMIUM_SET_FIGHTER = "Fighter";
	private static final String PREMIUM_SET_MAGE = "Mage";
	private static final String PREMIUM_SET_ALL = "All";
	private static final String PREMIUM_SET_NONE = "None";
	
	private String rebuildMainHtml(QuestState st)
	{
		String MAIN_HTML_MESSAGE = "<html><head><title>" + PREMIUM_TITLE_NAME + "</title></head><body><center><img src=\"L2UI_CH3.herotower_deco\" width=256 height=32>";
		String MESSAGE = "";
		int td = 0;
		String[] TRS =
		{
		...
		MAIN_HTML_MESSAGE += "<br><font color=303030>" + PREMIUM_TITLE_NAME + "</font>" + "</center></body></html>";
	...
	private PremiumNpcBuffer(int id, String name, String descr)
	{
		super(id, name, descr);
		addStartNpc(NPC_ID);
	...
	{
		return "<html><head><title>" + PREMIUM_TITLE_NAME + "</title></head><body><center><img src=\"L2UI_CH3.herotower_deco\" width=256 height=32><br><br>You MUST seprerate new words with a dot (.)<br><br>Scheme name: <edit var=\"name\" width=100><br><br>" + "<button value=\"Create Scheme\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " create $name no_name x x\" width=200 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<br><button value=\"Back\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect main 0 0\" width=100 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<br><font color=303030>" + PREMIUM_TITLE_NAME + "</font></center></body></html>";
	}
	
	private String deleteScheme(L2PcInstance player)
	{
		String HTML = "<html><head><title>" + PREMIUM_TITLE_NAME + "</title></head><body><center><img src=\"L2UI_CH3.herotower_deco\" width=256 height=32><br>Available schemes:<br><br>";
		try (Connection con = L2DatabaseFactory.getInstance().getConnection())
		{
			PreparedStatement rss = con.prepareStatement("SELECT * FROM premium_scheme_list WHERE player_id=?");
		...
		HTML += "<br><button value=\"Back\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect main 0 0\" width=100 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<br><font color=303030>" + PREMIUM_TITLE_NAME + "</font></center></body></html>";
		return HTML;
	}
	
	private String editScheme(L2PcInstance player)
	{
		String HTML = "<html><head><title>" + PREMIUM_TITLE_NAME + "</title></head><body><center><img src=\"L2UI_CH3.herotower_deco\" width=256 height=32><br>Select a scheme that you would like to manage:<br><br>";
		try (Connection con = L2DatabaseFactory.getInstance().getConnection())
		{
			PreparedStatement rss = con.prepareStatement("SELECT * FROM premium_scheme_list WHERE player_id=?");
			rss.setInt(1, player.getObjectId());
	...
	private String getOptionList(String scheme)
	{
		...
		String HTML = "<html><head><title>" + PREMIUM_TITLE_NAME + "</title></head><body><center><img src=\"L2UI_CH3.herotower_deco\" width=256 height=32><br>There are <font color=LEVEL>" + bcount + "</font> buffs in current scheme!<br><br>";
		...
		HTML += "<br><button value=\"Back\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " edit_1 0 0 0\" width=100 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<button value=\"Home\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect main 0 0\" width=100 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<br><font color=303030>" + PREMIUM_TITLE_NAME + "</font></center></body></html>";
		return HTML;
	}
	...
	private String buildHtml(String buffType)
	{
		...
		HTML_MESSAGE += "<br><button value=\"Back\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect main 0 0\" width=100 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<br><font color=303030>" + PREMIUM_TITLE_NAME + "</font></center></body></html>";
		return HTML_MESSAGE;
	}
	...
	private String viewAllSchemeBuffs(String scheme, String page, String action)
	{
		...
		try (Connection con = L2DatabaseFactory.getInstance().getConnection())
		{
			...
			{
				HTML_MESSAGE += "You can add <font color=LEVEL>" + (PREMIUM_MAX_SCHEME_BUFFS - BUFF_COUNT) + "</font> Buffs and <font color=LEVEL>" + (PREMIUM_MAX_SCHEME_DANCES - DANCE_SONG) + "</font> Dances more!";
		...
		HTML_MESSAGE += "<br><br><button value=\"Back\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " manage_scheme_select " + scheme + " x x\" width=100 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<button value=\"Home\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect main 0 0\" width=100 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<br><font color=303030>" + PREMIUM_TITLE_NAME + "</font></center></body></html>";
		return HTML_MESSAGE;
	} // viewAllSchemeBuffs
	...
	private String viewAllBuffTypes()
	{
		...
		HTML_MESSAGE += "<button value=\"Back\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect main 0 0\" width=100 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<br><font color=303030>" + PREMIUM_TITLE_NAME + "</font></center></body></html>";
		return HTML_MESSAGE;
	}
	...
	private String viewAllBuffs(String type, String typeName, String page)
	{
		...
		HTML_MESSAGE += "<br><br><button value=\"Back\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect manage_buffs 0 0\" width=100 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<button value=\"Home\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect main 0 0\" width=100 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<br><font color=303030>" + PREMIUM_TITLE_NAME + "</font></center></body></html>";
		return HTML_MESSAGE;
	}
		...
		switch (eventParam0)
		{
			...
			case "buffpet":
				if ((int) (System.currentTimeMillis() / 1000) > st.getInt("blockUntilTime"))
				{
					...
					if (PREMIUM_TIME_OUT)
					{
						addTimeout(st, 3, PREMIUM_TIME_OUT_TIME / 2, 600);
					}
				}
				return rebuildMainHtml(st);
			...
			case "delete_c":
				return "<html><head><title>" + PREMIUM_TITLE_NAME + "</title></head><body><center><img src=\"L2UI_CH3.herotower_deco\" width=256 height=32><br>Do you really want to delete '" + eventParam2 + "' scheme?<br><br>" + "<button value=\"Yes\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " delete " + eventParam1 + " x x\" width=50 height=25 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<button value=\"No\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " delete_1 x x x\" width=50 height=25 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<br><font color=303030>" + PREMIUM_TITLE_NAME + "</font></center></body></html>";
			...
			case "heal":
				if ((int) (System.currentTimeMillis() / 1000) > st.getInt("blockUntilTime"))
				{
					if (st.getQuestItemsCount(PREMIUM_CONSUMABLE_ID) < PREMIUM_HEAL_PRICE)
					{
						return showText(st, "Sorry", "You don't have the enough items:<br>You need: <font color=LEVEL>" + PREMIUM_HEAL_PRICE + " " + getItemNameHtml(st, PREMIUM_CONSUMABLE_ID) + "!", false, "0", "0");
					}
					...
					st.takeItems(PREMIUM_CONSUMABLE_ID, PREMIUM_HEAL_PRICE);
					if (PREMIUM_TIME_OUT)
					{
						addTimeout(st, 1, PREMIUM_TIME_OUT_TIME / 2, 600);
					}
				}
			...
			case "removeBuffs":
				if ((int) (System.currentTimeMillis() / 1000) > st.getInt("blockUntilTime"))
				{
					if (st.getQuestItemsCount(PREMIUM_CONSUMABLE_ID) < PREMIUM_BUFF_REMOVE_PRICE)
					{
						return showText(st, "Sorry", "You don't have the enough items:<br>You need: <font color=LEVEL>" + PREMIUM_BUFF_REMOVE_PRICE + " " + getItemNameHtml(st, PREMIUM_CONSUMABLE_ID) + "!", false, "0", "0");
					}
					final boolean getSummonbuff = isPetBuff(st);
					if (getSummonbuff)
					{
					...
					st.takeItems(PREMIUM_CONSUMABLE_ID, PREMIUM_BUFF_REMOVE_PRICE);
					if (PREMIUM_TIME_OUT)
					{
						addTimeout(st, 2, PREMIUM_TIME_OUT_TIME / 2, 600);
					}
				}
				return PREMIUM_SMART_WINDOW ? null : rebuildMainHtml(st);
			...
			case "cast":
				if ((int) (System.currentTimeMillis() / 1000) > st.getInt("blockUntilTime"))
				{
					...
					if (!PREMIUM_FREE_BUFFS)
					{
						if (st.getQuestItemsCount(PREMIUM_CONSUMABLE_ID) < PREMIUM_SCHEME_BUFF_PRICE)
						{
							return showText(st, "Sorry", "You don't have the enough items:<br>You need: <font color=LEVEL>" + PREMIUM_SCHEME_BUFF_PRICE + " " + getItemNameHtml(st, PREMIUM_CONSUMABLE_ID) + "!", false, "0", "0");
						}
					}
					...
					st.takeItems(PREMIUM_CONSUMABLE_ID, PREMIUM_SCHEME_BUFF_PRICE);
					if (PREMIUM_TIME_OUT)
					{
						addTimeout(st, 3, PREMIUM_TIME_OUT_TIME, 600);
					}
				}
				return PREMIUM_SMART_WINDOW ? null : rebuildMainHtml(st);
			...
			case "giveBuffs":
			{
				...
				if ((int) (System.currentTimeMillis() / 1000) > st.getInt("blockUntilTime"))
				{
					if (!PREMIUM_FREE_BUFFS)
					{
						if (st.getQuestItemsCount(PREMIUM_CONSUMABLE_ID) < cost)
						{
							return showText(st, "Sorry", "You don't have the enough items:<br>You need: <font color=LEVEL>" + cost + " " + getItemNameHtml(st, PREMIUM_CONSUMABLE_ID) + "!", false, "0", "0");
						}
					}
					...
					st.takeItems(PREMIUM_CONSUMABLE_ID, cost);
					if (PREMIUM_TIME_OUT)
					{
						addTimeout(st, 3, PREMIUM_TIME_OUT_TIME / 10, 600);
					}
				}
			...
			case "castBuffSet":
				if ((int) (System.currentTimeMillis() / 1000) > st.getInt("blockUntilTime"))
				{
					if (!PREMIUM_FREE_BUFFS)
					{
						if (st.getQuestItemsCount(PREMIUM_CONSUMABLE_ID) < PREMIUM_BUFF_SET_PRICE)
						{
							return showText(st, "Sorry", "You don't have the enough items:<br>You need: <font color=LEVEL>" + PREMIUM_BUFF_SET_PRICE + " " + getItemNameHtml(st, PREMIUM_CONSUMABLE_ID) + "!", false, "0", "0");
						}
					}
					...
					st.takeItems(PREMIUM_CONSUMABLE_ID, PREMIUM_BUFF_SET_PRICE);
					if (PREMIUM_TIME_OUT)
					{
						addTimeout(st, 3, PREMIUM_TIME_OUT_TIME, 600);
					}
	...
	public String onFirstTalk(L2Npc npc, L2PcInstance player)
	{
		...
		else if ((int) (System.currentTimeMillis() / 1000) > st.getInt("blockUntilTime"))
		{
			...
			{
				if ((PREMIUM_ENABLE_VIP_BUFFER) && (player.getPremiumService() == 1))
				{
					...
					{
						return showText(st, "Info", "Your level is too low!<br>You have to be at least level <font color=LEVEL>" + PREMIUM_MIN_LEVEL + "</font>,<br>to use my services!", false, "Return", "main");
					}
			...
			// BUFF FOR ALL
			else if ((PREMIUM_ENABLE_VIP_BUFFER) && (player.getPremiumService() == 1))
			{
				if (!PREMIUM_BUFF_WITH_KARMA && (player.getKarma() > 0))
				{
					return showText(st, "Info", "You have too much <font color=FF0000>karma!</font><br>Come back,<br>when you don't have any karma!", false, "Return", "main");
			...
			else if ((PREMIUM_ENABLE_VIP_BUFFER) && (player.getPremiumService() == 0))
			{
				return rebuildMainHtml(st);
			}
	...
	{
		new PremiumNpcBuffer(-1, QUEST_LOADING_INFO, "ai/npc/");
	}
}
