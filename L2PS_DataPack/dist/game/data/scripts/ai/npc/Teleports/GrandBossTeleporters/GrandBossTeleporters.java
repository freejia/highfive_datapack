...
import zones.GiranArea.AntharasLair.LandDragon;
import zones.GoddardArea.FireDragon;
...
public class GrandBossTeleporters extends AbstractNpcAI
{
	...
	{
		return QuestManager.getInstance().getQuest(FireDragon.class.getSimpleName());
	}
	
	private Quest antharasAI()
	{
		return QuestManager.getInstance().getQuest(LandDragon.class.getSimpleName());
	}
