...
import handlers.voicedcommandhandlers.Voiced_TvTVoicedInfo;
...
public class MasterHandler
{
	...
	private static final Class<?>[][] _handlers =
	{
		...
		},
		{
			...
			// custom
			Voiced_Premium.class,
			Voiced_BindingIP.class,
			Voiced_CastleManagerInfo.class,
			Voiced_OpenAtod.class,
			Voiced_TeleToCl.class,
			Voiced_Repair.class,
			Voiced_Experience.class,
			Antibot.class,
		},
		{
			// Target Handlers
