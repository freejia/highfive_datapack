...
public class Q00196_SevenSignSealOfTheEmperor extends Quest
{
	...
	private synchronized void enterInstance(L2PcInstance player)
	{
		...
		final int instanceId = InstanceManager.getInstance().createDynamicInstance("SevenSigns/SanctumSealOfTheEmperor.xml");
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		else if ("32593-02.htm".equals(event) && (player.getLevel() >= MIN_LEVEL))
		{
