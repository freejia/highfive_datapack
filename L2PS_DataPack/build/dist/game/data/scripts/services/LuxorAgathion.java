...
/**
 * Used in Luxor Shop NPC Alexandria (id: 30098), for sale Agathion-s.
 * @Author: SYS
 * @Date: 11/06/2012
 */
public class LuxorAgathion extends Functions
{
	...
	private static int SUCCESS_RATE = 60; // 60% The success rate
	private static int RARE_RATE = 5; // 5% the drop rate of rare skill with Agathion
