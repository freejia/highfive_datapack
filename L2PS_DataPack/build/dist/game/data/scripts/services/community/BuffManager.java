...
import l2f.gameserver.dao.BuffManagerDAO;
...
/**
 * @author KilRoy Community Board v2.0 Buff (Player/Pet + Sheme) MOD
 */
public class BuffManager implements ScriptFile, ICommunityBoardHandler
{
	...
	protected void BuffFixedGrp(Player activeChar, String GrpName, String target)
	{
		Connection con = null;
		CBBuffGroup bgrp;
		String allbuff = "";
		...
		try
		{
			...
			{
				activeChar.sendMessage("Not enought money.");
				return;
			}
	...
	protected void BuffGrp(Player activeChar, int buffIdUse, String target)
	{
		Connection con = null;
		CBBuffGroup bgrp;
		String allbuff = "";
	...
	private void StartBuffGrp(Player activeChar, String allbuff, String target)
	{
		...
		while (stBuff.hasMoreTokens())
		{
			...
			try
			{
				...
				{
					activeChar.sendMessage("Buff: " + skill.getName() + " (" + skill.getId() + "), не может быть использован!");
				}
			}
			catch (Exception e)
			{
	...
	private void BuffOne(Player activeChar, int buffIdUse, int buffLvL)
	{
		...
		{
			activeChar.sendMessage("Well are you stupid...");
			...
			AutoBan.Banned(activeChar, 999999, "Cheater detected! Auto ban. Buffer CB", "http://webdesign.fandc.ro"); // Ban this player
	...
	private void AddBuffInGrp(Player activeChar, int gpIdUse, int buff, int lvl)
	{
		...
		try
		{
			...
			{
				activeChar.sendMessage("A set cannot contain more than" + Config.BBS_PVP_BUFFER_BUFFS_PER_SET + " buffs");
			}
			DbUtils.closeQuietly(st, rs);
		}
		catch (Exception e)
	...
	private void EditeAddBuffInGrp(Player activeChar, int gpIdUse, int page)
	{
		...
		try
		{
			...
			htmltoppanel.append("<td><font color=30D249>Editing: " + GrpName + "</font></td>");
	...
	private void UseFixedBuffGrp(Player activeChar, String GrpName, int page)
	{
		...
		try
		{
			...
			htmltoppanel.append("<table width=600>");
			htmltoppanel.append("<tr>");
			htmltoppanel.append("<td><font color=30D249>[All: " + price + " adena]</font>");
			htmltoppanel.append("</td>");
			if (numpages <= 1)
			{
				htmltoppanel.append("<td>Yourself:</td>");
				htmltoppanel.append("<td><button value=\"All\" action=\"bypass _bbsbuff;bufffixedgrp;" + GrpName + "; Player\" width=40 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td>");
				if ((activeChar.getVar("autoBuff@") == null) && (activeChar.getVar("autoFixedBuff@") == null))
				{
					htmltoppanel.append("<td><button value=\"Enable auto-buff\" action=\"bypass _bbsbuff;buffgrpauto;0;" + GrpName + ";" + price + "\" width=140 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td>");
				}
				else
				{
					htmltoppanel.append("<td><button value=\"Disable auto-buff\" action=\"bypass _bbsbuff;buffgrpautostop;0;" + GrpName + "\" width=140 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td>");
				}
			}
			else
			{
			...
			if (l2Summon != null)
			{
				...
				if (numpages <= 1)
				{
					htmltoppanel.append("<td>Pet:</td>");
					htmltoppanel.append("<td><button value=\"All\" action=\"bypass _bbsbuff;bufffixedgrp;" + GrpName + "; Pet\" width=40 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td>");
					if ((activeChar.getVar("autoBuffPet@") == null) && (activeChar.getVar("autoFixedBuffPet@") == null))
					{
						htmltoppanel.append("<td><button value=\"Enable auto-buff\" action=\"bypass _bbsbuff;buffgrpautopet;0;" + GrpName + ";" + price + "\" width=140 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td>");
					}
					else
					{
						htmltoppanel.append("<td><button value=\"Disable auto-buff\" action=\"bypass _bbsbuff;buffgrpautopetstop;0;" + GrpName + "\" width=140 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td>");
					}
				}
				htmltoppanel.append("<td></td>");
				htmltoppanel.append("</tr>");
	...
	private void UseBuffGrp(Player activeChar, int gpIdUse)
	{
		...
		try
		{
			...
			htmltoppanel.append("<table width=600>");
			htmltoppanel.append("<tr>");
			htmltoppanel.append("<td><font color=30D249>" + GrpName + " [All: " + price + " adena]</font>");
			htmltoppanel.append("</td>");
			htmltoppanel.append("<td>Yourself:</td>");
			htmltoppanel.append("<td><button value=\"All\" action=\"bypass _bbsbuff;buffgrp;" + GrpID + "; Player\" width=40 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td>");
			
			if ((activeChar.getVar("autoBuff@") == null) && (activeChar.getVar("autoFixedBuff@") == null))
			{
				htmltoppanel.append("<td><button value=\"Enable auto-buff\" action=\"bypass _bbsbuff;buffgrpauto;" + GrpID + ";null;" + price + "\" width=140 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td>");
			}
			else
			{
				htmltoppanel.append("<td><button value=\"Disable auto-buff\" action=\"bypass _bbsbuff;buffgrpautostop;" + GrpID + ";null\" width=140 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td>");
			}
			...
			if (l2Summon != null)
			{
				...
				htmltoppanel.append("<td></td>");
				htmltoppanel.append("<td>Pet:</td>");
				htmltoppanel.append("<td><button value=\"All\" action=\"bypass _bbsbuff;buffgrp;" + GrpID + "; Pet\" width=40 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td>");
				if ((activeChar.getVar("autoBuffPet@") == null) && (activeChar.getVar("autoFixedBuffPet@") == null))
				{
					htmltoppanel.append("<td><button value=\"Enable auto-buff\" action=\"bypass _bbsbuff;buffgrpautopet;" + GrpID + ";null;" + price + "\" width=140 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td>");
				}
				else
				{
					htmltoppanel.append("<td><button value=\"Disable auto-buff\" action=\"bypass _bbsbuff;buffgrpautopetstop;" + GrpID + ";null\" width=140 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td>");
				}
				htmltoppanel.append("<td></td>");
				htmltoppanel.append("</tr>");
			}
	...
	private void AddBuffGrp(Player activeChar, String grpNameAdd)
	{
		...
		{
			activeChar.sendMessage("You have not entred name of group");
			return;
		}
		...
		try
		{
			...
			{
				activeChar.sendMessage("You cannot save more than 5 grups");
				return;
			}
		...
		for (int i = 0; i < (int) rows; i++)
		{
			...
			for (int j = 0; j < cols_number; j++)
			{
				if (buffIds.size() > c)
				{
					...
					res += "<td width=200>" + "<center>" + "<table width=200 height=32>" + "<tr>" + "<td width=32><center><img src=icon." + skill.getIcon() + " width=32 height=32></center></td>" + bottom + "<td width=128>" + "<table width=128><tr><td><font color=3293F3>" + skill.getName() + "</font></td></tr><tr><td><font color=F2C202>Level: " + skill.getBaseLevel() + "</font></td></tr></table>" + "</td>" + "</tr>" + "</table></center></td>";
				}
				else
				{
	...
	public boolean chekCondition(Player activeChar)
	{
		...
		{
			activeChar.sendMessage("Your level doesn't meet the requirement");
			return false;
		}
		...
		{
			activeChar.sendMessage("You cannot use at the momment");
			return false;
		}
		...
		// Allow only in peace zone
		if (Config.BBS_BUFF_PEACEZONE_ONLY && !activeChar.isInZonePeace())
		{
			activeChar.sendMessage(activeChar.isLangRus() ? "Community Buffer можно использовать только в мирной зоне" : "Community Buffer can be used only in a peaceful area");
			return false;
		}
	...
	private void StartAutoBuff(Player activeChar, int gpIdUse, String gpUseName, int price)
	{
		...
		if ((price > 0) && (activeChar.getAdena() < price))
		{
			activeChar.sendMessage("Not enough money to run auto-buff!");
			return;
		}
	...
	private void StartAutoBuffPet(Player activeChar, int gpIdUse, String gpUseName, int price)
	{
		...
		if (l2Summon == null)
		{
			activeChar.sendMessage("You don't have pet summoned");
			return;
		}
		...
		if ((price > 0) && (activeChar.getAdena() < price))
		{
			activeChar.sendMessage("Not enough money to enable auto-buff for pet!");
			return;
		}
	...
	{
		protected ScheduledFuture<?> buffTask = null;
		...
		class buff implements Runnable
		{
			...
			public void run()
			{
				try
				{
					...
					{
						activeChartoBuff.sendMessage("Not enough money to enable auto-buff! The task is stopped!");
					...
					{
						activeChartoBuff.sendMessage("Auto-buff can not run at the moment! The task is stopped!");
						stopBuffTask(true);
						return;
					}
		...
		protected buffTask(Player activeChar, int price, boolean fixed)
		{
	...
	{
		protected ScheduledFuture<?> buffTaskPet = null;
		...
		class buffPet implements Runnable
		{
			...
			public void run()
			{
				try
				{
					...
					if (l2Summon == null)
					{
						activeChartoBuff.sendMessage("Summon your pet in order to enable auto-buff! The task is stopped!");
					...
					if ((pricetoBuff > 0) && (activeChartoBuff.getAdena() < pricetoBuff))
					{
						activeChartoBuff.sendMessage("Not enough money to run auto-buff pet! The task is stopped!");
						stopPetBuffTask(true);
						return;
					}
					...
					if (activeChartoBuff.isDead() || activeChartoBuff.isAlikeDead() || activeChartoBuff.isCastingNow() || activeChartoBuff.isInCombat() || activeChartoBuff.isAttackingNow() || activeChartoBuff.isInOlympiadMode() || activeChartoBuff.isFlying() || activeChartoBuff.isTerritoryFlagEquipped() || activeChartoBuff.isInZone(ZoneType.SIEGE))
					{
						activeChartoBuff.sendMessage("Unable to run auto-buff pet in this! The task is stopped!");
						stopPetBuffTask(true);
						return;
					}
		...
		protected buffTaskPet(Player activeChar, long price, boolean fixed)
		{
