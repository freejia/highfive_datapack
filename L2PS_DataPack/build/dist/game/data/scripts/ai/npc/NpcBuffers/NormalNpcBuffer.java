 ...
 */
public class NormalNpcBuffer extends Quest
{
	...
	private static final String QUEST_LOADING_INFO = "NormalNpcBuffer";
	private static final int NPC_ID = 65534;
	
	private static final String NORMAL_TITLE_NAME = "Normal Buffer by L2PS";
	private static final boolean NORMAL_SCRIPT_RELOAD = false;
	private static final boolean NORMAL_SMART_WINDOW = Config.NormalNpcBuffer_SmartWindow;
	private static final boolean NORMAL_ENABLE_VIP_BUFFER = Config.NormalNpcBuffer_VIP;
	private static final boolean NORMAL_ENABLE_BUFF_SECTION = Config.NormalNpcBuffer_EnableBuff;
	private static final boolean NORMAL_ENABLE_SCHEME_SYSTEM = Config.NormalNpcBuffer_EnableScheme;
	private static final boolean NORMAL_ENABLE_HEAL = Config.NormalNpcBuffer_EnableHeal;
	private static final boolean NORMAL_ENABLE_BUFFS = Config.NormalNpcBuffer_EnableBuffs;
	private static final boolean NORMAL_ENABLE_RESIST = Config.NormalNpcBuffer_EnableResist;
	private static final boolean NORMAL_ENABLE_SONGS = Config.NormalNpcBuffer_EnableSong;
	private static final boolean NORMAL_ENABLE_DANCES = Config.NormalNpcBuffer_EnableDance;
	private static final boolean NORMAL_ENABLE_CHANTS = Config.NormalNpcBuffer_EnableChant;
	private static final boolean NORMAL_ENABLE_OTHERS = Config.NormalNpcBuffer_EnableOther;
	private static final boolean NORMAL_ENABLE_SPECIAL = Config.NormalNpcBuffer_EnableSpecial;
	private static final boolean NORMAL_ENABLE_CUBIC = Config.NormalNpcBuffer_EnableCubic;
	private static final boolean NORMAL_ENABLE_BUFF_REMOVE = Config.NormalNpcBuffer_EnableCancel;
	private static final boolean NORMAL_ENABLE_BUFF_SET = Config.NormalNpcBuffer_EnableBuffSet;
	private static final boolean NORMAL_BUFF_WITH_KARMA = Config.NormalNpcBuffer_EnableBuffPK;
	private static final boolean NORMAL_FREE_BUFFS = Config.NormalNpcBuffer_EnableFreeBuffs;
	private static final boolean NORMAL_TIME_OUT = Config.NormalNpcBuffer_EnableTimeOut;
	private static final int NORMAL_TIME_OUT_TIME = Config.NormalNpcBuffer_TimeOutTime;
	private static final int NORMAL_MIN_LEVEL = Config.NormalNpcBuffer_MinLevel;
	private static final int NORMAL_BUFF_REMOVE_PRICE = Config.NormalNpcBuffer_PriceCancel;
	private static final int NORMAL_HEAL_PRICE = Config.NormalNpcBuffer_PriceHeal;
	private static final int NORMAL_BUFF_PRICE = Config.NormalNpcBuffer_PriceBuffs;
	private static final int NORMAL_RESIST_PRICE = Config.NormalNpcBuffer_PriceResist;
	private static final int NORMAL_SONG_PRICE = Config.NormalNpcBuffer_PriceSong;
	private static final int NORMAL_DANCE_PRICE = Config.NormalNpcBuffer_PriceDance;
	private static final int NORMAL_CHANT_PRICE = Config.NormalNpcBuffer_PriceChant;
	private static final int NORMAL_OTHERS_PRICE = Config.NormalNpcBuffer_PriceOther;
	private static final int NORMAL_SPECIAL_PRICE = Config.NormalNpcBuffer_PriceSpecial;
	private static final int NORMAL_CUBIC_PRICE = Config.NormalNpcBuffer_PriceCubic;
	private static final int NORMAL_BUFF_SET_PRICE = Config.NormalNpcBuffer_PriceSet;
	private static final int NORMAL_SCHEME_BUFF_PRICE = Config.NormalNpcBuffer_PriceScheme;
	private static final int NORMAL_SCHEMES_PER_PLAYER = Config.NormalNpcBuffer_MaxScheme;
	private static final int NORMAL_CONSUMABLE_ID = Config.NormalNpcBuffer_consumableID;
	private static final int NORMAL_MAX_SCHEME_BUFFS = Config.NormalBuffMaxAmount;
	private static final int NORMAL_MAX_SCHEME_DANCES = Config.NormalDanceMaxAmout;
	
	private static final String NORMAL_SET_FIGHTER = "Fighter";
	private static final String NORMAL_SET_MAGE = "Mage";
	private static final String NORMAL_SET_ALL = "All";
	private static final String NORMAL_SET_NONE = "None";
	
	private String rebuildMainHtml(QuestState st)
	{
		String MAIN_HTML_MESSAGE = "<html><head><title>" + NORMAL_TITLE_NAME + "</title></head><body><center><img src=\"L2UI_CH3.herotower_deco\" width=256 height=32>";
		String MESSAGE = "";
		int td = 0;
		String[] TRS =
		{
		...
		if (NORMAL_ENABLE_BUFF_SECTION)
		{
			if (NORMAL_ENABLE_BUFFS)
			{
				if (td > 2)
				{
					td = 0;
		...
		if (MESSAGE.length() > 0)
		{
			MAIN_HTML_MESSAGE += "<BR1><table width=100% border=0 cellspacing=0 cellpadding=1 bgcolor=444444><tr>" + "<td><font color=00FFFF>Preset:</font></td><td align=right><font color=LEVEL>" + formatAdena(NORMAL_BUFF_SET_PRICE) + "</font> adena</td></tr></table>" + "<BR1><table cellspacing=0 cellpadding=0>" + MESSAGE + "</table>";
			MESSAGE = "";
			td = 0;
		}
		
		if (NORMAL_ENABLE_SCHEME_SYSTEM)
		{
		...
		MAIN_HTML_MESSAGE += "<br><font color=303030>" + NORMAL_TITLE_NAME + "</font>" + "</center></body></html>";
	...
	private String generateScheme(QuestState st)
	{
		...
		HTML += "<BR1><table width=100% border=0 cellspacing=0 cellpadding=1 bgcolor=444444><tr>" + "<td><font color=00FFFF>Scheme:</font></td><td align=right><font color=LEVEL>" + formatAdena(NORMAL_SCHEME_BUFF_PRICE) + "</font> adena</TD></TR></table>" + "<BR1><table cellspacing=0 cellpadding=0>";
		...
		if (schemeName.size() < NORMAL_SCHEMES_PER_PLAYER)
		{
	...
	{
		String MESSAGE = "<html><head><title>" + NORMAL_TITLE_NAME + "</title></head><body><center><img src=\"L2UI_CH3.herotower_deco\" width=256 height=32><br>";
		...
		MESSAGE += "<font color=303030>" + NORMAL_TITLE_NAME + "</font></center></body></html>";
	...
	private NormalNpcBuffer(int id, String name, String descr)
	{
		super(id, name, descr);
		addStartNpc(NPC_ID);
	...
	{
		return "<html><head><title>" + NORMAL_TITLE_NAME + "</title></head><body><center><img src=\"L2UI_CH3.herotower_deco\" width=256 height=32><br><br>You MUST seprerate new words with a dot (.)<br><br>Scheme name: <edit var=\"name\" width=100><br><br>" + "<button value=\"Create Scheme\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " create $name no_name x x\" width=200 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<br><button value=\"Back\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect main 0 0\" width=100 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<br><font color=303030>" + NORMAL_TITLE_NAME + "</font></center></body></html>";
	}
	
	private String deleteScheme(L2PcInstance player)
	{
		String HTML = "<html><head><title>" + NORMAL_TITLE_NAME + "</title></head><body><center><img src=\"L2UI_CH3.herotower_deco\" width=256 height=32><br>Available schemes:<br><br>";
		try (Connection con = L2DatabaseFactory.getInstance().getConnection())
		{
			PreparedStatement rss = con.prepareStatement("SELECT * FROM npcbuffer_scheme_list WHERE player_id=?");
		...
		HTML += "<br><button value=\"Back\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect main 0 0\" width=100 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<br><font color=303030>" + NORMAL_TITLE_NAME + "</font></center></body></html>";
		return HTML;
	}
	
	private String editScheme(L2PcInstance player)
	{
		String HTML = "<html><head><title>" + NORMAL_TITLE_NAME + "</title></head><body><center><img src=\"L2UI_CH3.herotower_deco\" width=256 height=32><br>Select a scheme that you would like to manage:<br><br>";
		try (Connection con = L2DatabaseFactory.getInstance().getConnection())
		{
			PreparedStatement rss = con.prepareStatement("SELECT * FROM npcbuffer_scheme_list WHERE player_id=?");
			rss.setInt(1, player.getObjectId());
	...
	private String getOptionList(String scheme)
	{
		...
		String HTML = "<html><head><title>" + NORMAL_TITLE_NAME + "</title></head><body><center><img src=\"L2UI_CH3.herotower_deco\" width=256 height=32><br>There are <font color=LEVEL>" + bcount + "</font> buffs in current scheme!<br><br>";
		if (bcount < (NORMAL_MAX_SCHEME_BUFFS + NORMAL_MAX_SCHEME_DANCES))
		{
		...
		HTML += "<br><button value=\"Back\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " edit_1 0 0 0\" width=100 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<button value=\"Home\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect main 0 0\" width=100 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<br><font color=303030>" + NORMAL_TITLE_NAME + "</font></center></body></html>";
		return HTML;
	}
	
	private String buildHtml(String buffType)
	{
		String HTML_MESSAGE = "<html><head><title>" + NORMAL_TITLE_NAME + "</title></head><body><center><br>";
		...
		else
		{
			...
			else
			{
				...
				{
					case "buff":
						price = NORMAL_BUFF_PRICE;
						break;
					case "resist":
						price = NORMAL_RESIST_PRICE;
						break;
					case "song":
						price = NORMAL_SONG_PRICE;
						break;
					case "dance":
						price = NORMAL_DANCE_PRICE;
						break;
					case "chant":
						price = NORMAL_CHANT_PRICE;
						break;
					case "others":
						price = NORMAL_OTHERS_PRICE;
						break;
					case "special":
						price = NORMAL_SPECIAL_PRICE;
						break;
					case "cubic":
						price = NORMAL_CUBIC_PRICE;
						break;
					default:
						if (DEBUG)
						{
		...
		HTML_MESSAGE += "<br><button value=\"Back\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect main 0 0\" width=100 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<br><font color=303030>" + NORMAL_TITLE_NAME + "</font></center></body></html>";
		return HTML_MESSAGE;
	}
	...
	private String generateQuery(int case1, int case2)
	{
		...
		if (NORMAL_ENABLE_BUFFS)
		{
			if (case1 < NORMAL_MAX_SCHEME_BUFFS)
			{
				qry.append(",\"buff\"");
			}
		}
		...
		if (NORMAL_ENABLE_SONGS)
		{
			if (case2 < NORMAL_MAX_SCHEME_DANCES)
			{
				qry.append(",\"song\"");
			}
		}
	...
	private String viewAllSchemeBuffs(String scheme, String page, String action)
	{
		...
		try (Connection con = L2DatabaseFactory.getInstance().getConnection())
		{
			...
			{
				HTML_MESSAGE += "You can add <font color=LEVEL>" + (NORMAL_MAX_SCHEME_BUFFS - BUFF_COUNT) + "</font> Buffs and <font color=LEVEL>" + (NORMAL_MAX_SCHEME_DANCES - DANCE_SONG) + "</font> Dances more!";
		...
		HTML_MESSAGE += "<br><br><button value=\"Back\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " manage_scheme_select " + scheme + " x x\" width=100 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<button value=\"Home\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect main 0 0\" width=100 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<br><font color=303030>" + NORMAL_TITLE_NAME + "</font></center></body></html>";
		return HTML_MESSAGE;
	} // viewAllSchemeBuffs
	
	private String viewAllBuffTypes()
	{
		String HTML_MESSAGE = "<html><head><title>" + NORMAL_TITLE_NAME + "</title></head><body><center><img src=\"L2UI_CH3.herotower_deco\" width=256 height=32><br>";
		...
		HTML_MESSAGE += "<button value=\"Back\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect main 0 0\" width=100 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<br><font color=303030>" + NORMAL_TITLE_NAME + "</font></center></body></html>";
		return HTML_MESSAGE;
	}
	...
	private String viewAllBuffs(String type, String typeName, String page)
	{
		...
		for (int i = start; i < end; ++i)
		{
			...
			if (type.equals("set"))
			{
				...
				if (forClass == 0)
				{
					listOrder = "List=\"" + NORMAL_SET_FIGHTER + ";" + NORMAL_SET_MAGE + ";" + NORMAL_SET_ALL + ";" + NORMAL_SET_NONE + ";\"";
				}
				else if (forClass == 1)
				{
					listOrder = "List=\"" + NORMAL_SET_MAGE + ";" + NORMAL_SET_FIGHTER + ";" + NORMAL_SET_ALL + ";" + NORMAL_SET_NONE + ";\"";
				}
				else if (forClass == 2)
				{
					listOrder = "List=\"" + NORMAL_SET_ALL + ";" + NORMAL_SET_FIGHTER + ";" + NORMAL_SET_MAGE + ";" + NORMAL_SET_NONE + ";\"";
				}
				else if (forClass == 3)
				{
					listOrder = "List=\"" + NORMAL_SET_NONE + ";" + NORMAL_SET_FIGHTER + ";" + NORMAL_SET_MAGE + ";" + NORMAL_SET_ALL + ";\"";
				}
		...
		HTML_MESSAGE += "<br><br><button value=\"Back\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect manage_buffs 0 0\" width=100 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<button value=\"Home\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " redirect main 0 0\" width=100 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<br><font color=303030>" + NORMAL_TITLE_NAME + "</font></center></body></html>";
		return HTML_MESSAGE;
	}
		...
		switch (eventParam0)
		{
			...
			case "buffpet":
				if ((int) (System.currentTimeMillis() / 1000) > st.getInt("blockUntilTime"))
				{
					...
					if (NORMAL_TIME_OUT)
					{
						addTimeout(st, 3, NORMAL_TIME_OUT_TIME / 2, 600);
					}
				}
				return rebuildMainHtml(st);
			...
			case "delete_c":
				return "<html><head><title>" + NORMAL_TITLE_NAME + "</title></head><body><center><img src=\"L2UI_CH3.herotower_deco\" width=256 height=32><br>Do you really want to delete '" + eventParam2 + "' scheme?<br><br>" + "<button value=\"Yes\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " delete " + eventParam1 + " x x\" width=50 height=25 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<button value=\"No\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " delete_1 x x x\" width=50 height=25 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "<br><font color=303030>" + NORMAL_TITLE_NAME + "</font></center></body></html>";
			...
			case "add_buff":
			{
				...
				int temp = Integer.parseInt(eventParam3) + 1;
				final String HTML;
				if (temp >= (NORMAL_MAX_SCHEME_BUFFS + NORMAL_MAX_SCHEME_DANCES))
				{
					HTML = getOptionList(scheme);
				}
				else
			...
			case "changeBuffSet":
				if (eventParam2.equals(NORMAL_SET_FIGHTER))
				{
					eventParam2 = "0";
				}
				else if (eventParam2.equals(NORMAL_SET_MAGE))
				{
					eventParam2 = "1";
				}
				else if (eventParam2.equals(NORMAL_SET_ALL))
				{
					eventParam2 = "2";
				}
				else if (eventParam2.equals(NORMAL_SET_NONE))
				{
					eventParam2 = "3";
				}
				else if (DEBUG)
			...
			case "heal":
				if ((int) (System.currentTimeMillis() / 1000) > st.getInt("blockUntilTime"))
				{
					if (st.getQuestItemsCount(NORMAL_CONSUMABLE_ID) < NORMAL_HEAL_PRICE)
					{
						return showText(st, "Sorry", "You don't have the enough items:<br>You need: <font color=LEVEL>" + NORMAL_HEAL_PRICE + " " + getItemNameHtml(st, NORMAL_CONSUMABLE_ID) + "!", false, "0", "0");
					}
					...
					st.takeItems(NORMAL_CONSUMABLE_ID, NORMAL_HEAL_PRICE);
					if (NORMAL_TIME_OUT)
					{
						addTimeout(st, 1, NORMAL_TIME_OUT_TIME / 2, 600);
					}
				}
				return NORMAL_SMART_WINDOW ? null : rebuildMainHtml(st);
				
			case "removeBuffs":
				if ((int) (System.currentTimeMillis() / 1000) > st.getInt("blockUntilTime"))
				{
					if (st.getQuestItemsCount(NORMAL_CONSUMABLE_ID) < NORMAL_BUFF_REMOVE_PRICE)
					{
						return showText(st, "Sorry", "You don't have the enough items:<br>You need: <font color=LEVEL>" + NORMAL_BUFF_REMOVE_PRICE + " " + getItemNameHtml(st, NORMAL_CONSUMABLE_ID) + "!", false, "0", "0");
					}
					final boolean getSummonbuff = isPetBuff(st);
					if (getSummonbuff)
					{
					...
					st.takeItems(NORMAL_CONSUMABLE_ID, NORMAL_BUFF_REMOVE_PRICE);
					if (NORMAL_TIME_OUT)
					{
						addTimeout(st, 2, NORMAL_TIME_OUT_TIME / 2, 600);
					}
				}
				return NORMAL_SMART_WINDOW ? null : rebuildMainHtml(st);
			...
			case "cast":
				if ((int) (System.currentTimeMillis() / 1000) > st.getInt("blockUntilTime"))
				{
					...
					if (!NORMAL_FREE_BUFFS)
					{
						if (st.getQuestItemsCount(NORMAL_CONSUMABLE_ID) < NORMAL_SCHEME_BUFF_PRICE)
						{
							return showText(st, "Sorry", "You don't have the enough items:<br>You need: <font color=LEVEL>" + NORMAL_SCHEME_BUFF_PRICE + " " + getItemNameHtml(st, NORMAL_CONSUMABLE_ID) + "!", false, "0", "0");
						}
					}
					...
					st.takeItems(NORMAL_CONSUMABLE_ID, NORMAL_SCHEME_BUFF_PRICE);
					if (NORMAL_TIME_OUT)
					{
						addTimeout(st, 3, NORMAL_TIME_OUT_TIME, 600);
					}
				}
				return NORMAL_SMART_WINDOW ? null : rebuildMainHtml(st);
			...
			case "giveBuffs":
			{
				...
				{
					case "buff":
						cost = NORMAL_BUFF_PRICE;
						break;
					case "resist":
						cost = NORMAL_RESIST_PRICE;
						break;
					case "song":
						cost = NORMAL_SONG_PRICE;
						break;
					case "dance":
						cost = NORMAL_DANCE_PRICE;
						break;
					case "chant":
						cost = NORMAL_CHANT_PRICE;
						break;
					case "others":
						cost = NORMAL_OTHERS_PRICE;
						break;
					case "special":
						cost = NORMAL_SPECIAL_PRICE;
						break;
					case "cubic":
						cost = NORMAL_CUBIC_PRICE;
						break;
					default:
						throw new RuntimeException();
				}
				...
				if ((int) (System.currentTimeMillis() / 1000) > st.getInt("blockUntilTime"))
				{
					if (!NORMAL_FREE_BUFFS)
					{
						if (st.getQuestItemsCount(NORMAL_CONSUMABLE_ID) < cost)
						{
							return showText(st, "Sorry", "You don't have the enough items:<br>You need: <font color=LEVEL>" + cost + " " + getItemNameHtml(st, NORMAL_CONSUMABLE_ID) + "!", false, "0", "0");
						}
					}
					...
					st.takeItems(NORMAL_CONSUMABLE_ID, cost);
					if (NORMAL_TIME_OUT)
					{
						addTimeout(st, 3, NORMAL_TIME_OUT_TIME / 10, 600);
					}
				}
				return NORMAL_SMART_WINDOW ? null : buildHtml(eventParam3);
			}
			...
			case "castBuffSet":
				if ((int) (System.currentTimeMillis() / 1000) > st.getInt("blockUntilTime"))
				{
					if (!NORMAL_FREE_BUFFS)
					{
						if (st.getQuestItemsCount(NORMAL_CONSUMABLE_ID) < NORMAL_BUFF_SET_PRICE)
						{
							return showText(st, "Sorry", "You don't have the enough items:<br>You need: <font color=LEVEL>" + NORMAL_BUFF_SET_PRICE + " " + getItemNameHtml(st, NORMAL_CONSUMABLE_ID) + "!", false, "0", "0");
						}
					}
					...
					st.takeItems(NORMAL_CONSUMABLE_ID, NORMAL_BUFF_SET_PRICE);
					if (NORMAL_TIME_OUT)
					{
						addTimeout(st, 3, NORMAL_TIME_OUT_TIME, 600);
					}
	...
	public String onFirstTalk(L2Npc npc, L2PcInstance player)
	{
		...
		{
			// BUFF ONLY FOR VIP - ENABLE_VIP_BUFFER = must be enabled
			if (Config.PremiumVIP_ONLY)
			{
				if ((NORMAL_ENABLE_VIP_BUFFER) && (player.getPremiumService() == 0))
				{
					if (!NORMAL_BUFF_WITH_KARMA && (player.getKarma() > 0))
					{
					...
					else if (player.getLevel() < NORMAL_MIN_LEVEL)
					{
						return showText(st, "Info", "Your level is too low!<br>You have to be at least level <font color=LEVEL>" + NORMAL_MIN_LEVEL + "</font>,<br>to use my services!", false, "Return", "main");
					}
			...
			// BUFF FOR ALL
			else if ((NORMAL_ENABLE_VIP_BUFFER) && (player.getPremiumService() == 0))
			{
				if (!NORMAL_BUFF_WITH_KARMA && (player.getKarma() > 0))
				{
					return showText(st, "Info", "You have too much <font color=FF0000>karma!</font><br>Come back,<br>when you don't have any karma!", false, "Return", "main");
			...
			else if (!NORMAL_BUFF_WITH_KARMA && (player.getKarma() > 0))
			{
				return showText(st, "Info", "You have too much <font color=FF0000>karma!</font><br>Come back,<br>when you don't have any karma!", false, "Return", "main");
			}
			else if (OlympiadManager.getInstance().isRegistered(player))
			...
			return showText(st, "Sorry", "This buffer is only for Normal Players!<br>Contact the administrator for more info!", false, "Return", "main");
		}
		else
		{
	...
	{
		new NormalNpcBuffer(-1, QUEST_LOADING_INFO, "ai/npc/");
	}
}
