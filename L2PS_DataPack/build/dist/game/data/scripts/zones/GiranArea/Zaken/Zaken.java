...
public class Zaken extends AbstractNpcAI
{
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		{
			ZWorld world = (ZWorld) tmpworld;
			if ((event.equalsIgnoreCase("lightBarrel")) && (npc != null))
			{
			...
			else if ((event.equalsIgnoreCase("RedBarrel")) && (npc != null))
			{
			...
			else if ((event.equalsIgnoreCase("BlueBarrel")) && (npc != null))
			{
	...
	public static void main(String[] args)
	{
		...
		new Zaken(Zaken.class.getSimpleName(), "zones/GiranArea/");
	}
}