 ...
 */
package zones.Freya.FreyaFirstVisit;
...
public class FreyaFirstVisit extends Quest
{
	...
	private static final int _freya_controller = 36600;
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		if (npcId == _jinia_2)
		{
			...
			if (enterInstance(player, "Freya/FreyaFirstVisit.xml", tele) <= 0)
			{
				return "32781-10.htm";
			}
		}
	...
	{
		new FreyaFirstVisit(-1, FreyaFirstVisit.class.getSimpleName(), "zones/Freya/");
	}
}