 ...
 */
package zones.SevenSigns.MonasteryGrandLibrary;
...
public class MonasteryGrandLibrary extends Quest
{
	...
	protected void enterInstance(L2Npc npc, L2PcInstance player)
	{
		...
		final int instanceId = InstanceManager.getInstance().createDynamicInstance("SevenSigns/MonasteryGrandLibrary.xml");
	...
	{
		new MonasteryGrandLibrary(-1, qn, "zones/SevenSigns/");
	}
}
