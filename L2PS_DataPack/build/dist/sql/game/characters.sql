...
CREATE TABLE `characters` (
  ...
  `lastVoteHopzone` bigint(20) DEFAULT NULL,
  `lastVoteTopzone` bigint(20) DEFAULT NULL,
  `hasVotedHop` int(10) DEFAULT NULL,
  `hasVotedTop` int(10) DEFAULT NULL,
  `monthVotes` int(10) DEFAULT NULL,
  `totalVotes` int(10) DEFAULT NULL,
  `tries` int(10) DEFAULT NULL,
  `bot_report_points` int(10) DEFAULT '7',
  PRIMARY KEY (`charId`),
